...
public class _01_Need_For_Collection {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            variable so that readability of the code is improved.
            ...
            1.	Arrays are fixed in size, there is no chance of increasing /decreasing the
                ...
                the size in advance and which may not be possible always.

            2.	Arrays can hold only homogenous data type elements.

            3.	Arrays concept is not implemented based on some Standard DSA and hence ready-made
            ...
            3.	Every Collection class is implemented based on some standard DSA and hence for every
                requirement ready-made method support is available. Being a programmer, we are
                responsible to use those methods.
        */
        ...
        /*
            ...
            5. There is no underlying DSA for Arrays and hence ready-made methods is not available.
