...
public class _01_Java_Commands {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            By default, JVM will always searches in current working directory for the
            ...
            ===========================================
            This way of setting classpath is permanent and will be preserved when system
            restarts. Whenever we are installing a permanent software in a system, then
            ...
            3.	At command level
            ====================
            By using -cp option. Java -cp c:\excercises Test
            ...
            1.	If any location is created because of a package statement, that location
                ...
                we have to update in classpath.
